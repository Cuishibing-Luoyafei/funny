        ...
        Object o = Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
                new Class[]{clazz}, new InvocationHandler() {
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        return DefaultProxyFactory.invoke(clazz.getName(), method.getName(), serviceInfo.getPosition(), args);
                    }
                });
        return (T) o;
    }

    public <T> T getProxy(Class<T> clazz, ServicePosition position) {
        Object o = Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(),
                new Class[]{clazz}, new InvocationHandler() {
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        return DefaultProxyFactory.invoke(clazz.getName(), method.getName(), position, args);
                    }
                });
        return (T) o;
    }

    private static Object invoke(String type, String methodName, ServicePosition position, Object[] args) throws Exception {
