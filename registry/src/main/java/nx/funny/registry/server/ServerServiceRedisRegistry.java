...
public class ServerServiceRedisRegistry implements ServiceRegistry {
    ...
    public ServerServiceRedisRegistry(String redisHost, int redisPort, String name, String password) {
        this(redisHost, redisPort,
                ...
                new DefaultDeStringSerializer());
    }

    public ServerServiceRedisRegistry(String redisHost, int redisPort,
    ...
    public void register(ServiceInfo info) {
        ...
        if (!success)
            register(info);
        else logger.log(Level.INFO, "register:" + info.toString());
    }
    ...
    public void remove(ServiceInfo info) {
        ...
        if (!success)
            remove(info);
        else logger.log(Level.INFO, "remove:" + info.toString());
    }
    ...
    public void removeAll(ServiceType type) {
        ...
        if (!success)
            removeAll(type);
        else logger.log(Level.INFO, "removeAll:" + type.toString());
    }
